...
(function($) {
	...
	$(document).ready(function() {
		...
		/* ==================================================
            # MTS Brand List (Client Logos)
         ===============================================*/
		var mtsBrandList = new Swiper(".mySwiper-brand-list", {
			slidesPerView: 6,
			spaceBetween: 30,
			loop: true,
			speed: 1500,
			...
			breakpoints: {
				...
				991:  { slidesPerView: 5, centeredSlides: false },
				768:  { slidesPerView: 4, centeredSlides: false },
				568:  { slidesPerView: 3, centeredSlides: false },
				0:    { slidesPerView: 3, centeredSlides: false }
			},
		});

		var mtsPartnerList = new Swiper(".mySwiper-partner-list", {
			slidesPerView: 6,
			spaceBetween: 30,
			loop: true,
			speed: 1500,
